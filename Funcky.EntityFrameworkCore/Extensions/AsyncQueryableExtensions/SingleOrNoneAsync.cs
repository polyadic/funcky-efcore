...
namespace Funcky.EntityFrameworkCore.Extensions
{
    public static partial class AsyncQueryableExtensions
    {
        ...
        public static Task<Option<TSource>> SingleOrNoneAsync<TSource>(this IQueryable<TSource> source)
        ...
        /// </summary>
        /// <typeparam name="TSource">the inner type of the queryable.</typeparam>
        public static Task<Option<TSource>> SingleOrNoneAsync<TSource>(this IQueryable<TSource> source, Expression<Func<TSource, bool>> predicate)
            where TSource : notnull
            => source
                .Where(predicate)
                .Select(x => Option.Some(x))
